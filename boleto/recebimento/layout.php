    ...
    <table width="600" border="0" align="center" cellpadding="0" cellspacing="5">
        <tr>
            <td align="center" height="100">
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        <td align="left"><?php if ($CONF_BRASAO) { ?><img src="../../img/brasoes/<?php echo isTenancyAppBySubdomain() . rawurlencode($CONF_BRASAO); ?>" width="60" height="60"><?php } ?></td>
                        <td align="left">
                            ...
                            <span class="cab02">ISSQN - Guia para Pagamento</span>
                        </td>
                    </tr>
                </table>
            </td>
        ...
        <tr>
            <td align="center">
                <table width="100%" border="0" cellspacing="0" cellpadding="2">
                    <tr>
                        <td style="border:#000000 solid 2px;">ATIVADE(S):<br>
                            <?php
                            $contservicos = 1;
        ...
        <tr>
            <td align="center">
                <table width="100%" border="0" cellspacing="0" cellpadding="2" align="center" style="border:#000000 solid 2px;">
                    <tr>
                        <td><?php if ($CONF_BRASAO) { ?><img src="../../img/brasoes/<?php echo isTenancyAppBySubdomain() . rawurlencode($CONF_BRASAO); ?>" width="60" height="60"><?php } ?></td>
                        <td align="right">
        ...
        <tr>
            <td align="center">
                <table width="100%" border="0" cellspacing="0" cellpadding="2" style="border:#000000 solid 2px;">
                    <tr>
                        <td><?php if ($CONF_BRASAO) { ?><img src="../../img/brasoes/<?php echo isTenancyAppBySubdomain() . rawurlencode($CONF_BRASAO); ?>" width="60" height="60"><?php } ?></td>
                        <td align="right">
                            <table width="100%" border="0" cellspacing="2" cellpadding="0">
