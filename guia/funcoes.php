...
function geraCodigoDeBarras($valor)
{
  ...
  //Guarda inicial
?>
  <img src=img/p.gif width=<?= $fino ?> height=<?= $altura ?> border=0><img src=img/b.gif width=<?= $fino ?> height=<?= $altura ?> border=0><img src=img/p.gif width=<?= $fino ?> height=<?= $altura ?> border=0><img src=img/b.gif width=<?= $fino ?> height=<?= $altura ?> border=0><img <?php
                                                                  ...
                                                                  ?> src=img/b.gif width=<?= $f2 ?> height=<?= $altura ?> border=0><img <?
                                                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                                                            // Draw guarda final
                                                                  ?> src=img/p.gif width=<?= $largo ?> height=<?= $altura ?> border=0><img src=img/b.gif width=<?= $fino ?> height=<?= $altura ?> border=0><img src=img/p.gif width=<?= 1 ?> height=<?= $altura ?> border=0>
<?
} //Fim da fun��o
