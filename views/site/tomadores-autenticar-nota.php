...
<div class="row">
    ...
    <div class="col-sm-12 col-md-4 col-lg-4" style="margin-bottom: 16px;">
        <div class="card" style="height: 100%;">
            ...
            <div class="card-footer">
                ...
                <a href="<?= url('site/tomadores/consultar-rps') ?>">Serviço online</a>
            </div>
        </div>
    </div>
    ...
    <div class="col-sm-12 col-md-4 col-lg-4" style="margin-bottom: 16px;">
        <div class="card" style="height: 100%;">
            ...
            <div class="card-footer">
                <img src="../img/box/web.png" width="14" height="14">
                <a href="<?= url('site/tomadores/autenticar-nota') ?>">Serviço online</a>
            </div>
        </div>
        <br>
    </div>
    ...
    <div class="col-sm-12 col-md-4 col-lg-4" style="margin-bottom: 16px;">
        <div class="card" style="height: 100%;">
            ...
            <div class="card-footer">
                <img src="../img/box/web.png" width="14" height="14">
                <a href="<?= url('site/tomadores/gerar-guia') ?>">Serviço online</a>
            </div>
        </div>
        <br>
    </div>
