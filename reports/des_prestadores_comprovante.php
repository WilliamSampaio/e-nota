...
<head>
	...
	<link href="../css/imprimir_descomprovantes.css" rel="stylesheet" type="text/css">
</head>
<?php
session_start();
...
if ($_GET['COD']) {
	...
	$sql = $PDO->query("
		...
		WHERE
		  des.codigo = '$CODDES'");
	list(
		$codigo, $razaosocial, $cnpj, $cpf, $inscrmunicipal, $endereco,
		$competencia, $data_gerado, $total, $codverificacao
	) = $sql->fetch();
}
if ($_GET['CODI']) {
	$CODDES = $_GET['CODI'];
	...
	$sql = $PDO->query("
		...
		");
	list(
		$codigo, $razaosocial, $cnpj, $cpf, $inscrmunicipal, $logradouro,
		$numero, $complemento, $competencia, $data_gerado, $codverificacao
	) = $sql->fetch();
	$cnpj .= $cpf;
	$endereco = "$logradouro, $numero";
	if ($complemento)
		$endereco .= ", $complemento";
	$sql2 = $PDO->query("SELECT SUM(valor_nota) FROM des_issretido_notas WHERE coddes_issretido = '$CODDES'");
	...
	<table width="800" border="0" cellspacing="0" cellpadding="5" align="center">
					...
					<tr>
						...
						<td width="520" style="border:0px;" align="left" valign="middle">
							...
							<font class="secretaria"><?php echo $CONF_SECRETARIA; ?><br>
								Comprovante de Declaração Eletrônica de Serviços de ISS</font>
						</td>
					</tr>
				</table>
			</td>
		...
		<tr>
			<td height="30" align="center">
				<font class="prefeitura"><?php echo $codigo; ?></font>
			</td>
			<td align="center">
				<font class="prefeitura"><?php echo $codverificacao; ?></font>
			</td>
			<td align="center">
				<font class="prefeitura"><?php echo DataPt($data_gerado); ?></font>
			</td>
			<td align="center">
				<font class="prefeitura"><?php echo $competencia; ?></font>
			</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td width="25%" valign="top">CNPJ/CPF<br>
				<font class="prefeitura"><?php echo $cnpj; ?></font>
			</td>
		</tr>
		<tr>
