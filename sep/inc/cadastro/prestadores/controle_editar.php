...
<?php if ($btUpdate !="")
 ...
 $sql=$PDO->query("SELECT nome, estado, razaosocial, cnpjcpf, inscrmunicipal, endereco, municipio, uf,email, estado,simplesnacional FROM emissores WHERE codigo = '$COD'");
   list($nome,$estado, $razaosocial, $cnpjcpf, $inscrmunicipal, $endereco, $municipio, $uf,$email, $estado,$simplesnacional)=$sql->fetch();?>
...
<?php $sql=$PDO->query("SELECT codigo, nome, cpf FROM emissores_socios WHERE codemissor = '$COD'");
...
<!------------------------------ Lista os serviços a serem editados FIM--------------------------------------->	  
	     <tr>
	      <td align="left" colspan="4">
		   ...
		   <?php require_once("empresas_socios.php");?>	
		   </table>		  </td>			  
		 </tr> 
		 <tr>
		  ...
		  <td align="left" colspan="4">
		   <table width="500" border="0">
		    ...
		    <?php require_once("empresas_servicos.php");?>		  
		    </table>		 </td>			  
		</tr> 
	    <tr>
	      <td align="left"><br>
