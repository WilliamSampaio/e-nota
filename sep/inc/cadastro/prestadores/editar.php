...
$codtipo_prestador = $array_codtipo[0];
	...
	$sql_categoria=$PDO->query("SELECT codigo FROM servicos_categorias WHERE nome = 'Contabil'");	
...
$sql_dados_empresa=$PDO->query("SELECT nome,codtipo,codtipodeclaracao,razaosocial,$campo,inscrmunicipal,inscrestadual,email,logradouro,numero,estado,nfe,pispasep, datainicio, datafim, cep, fonecomercial, fonecelular, municipio, complemento, bairro FROM cadastro
 WHERE codigo = '$codigoempresa'");
list(
	$Nempresa,$CodTipo,$CodTipoDec,$Rempresa,$CNCPempresa,$Iempresa,$IMempresa,$ESempresa,$EMempresa,$ENempresa,$NMempresa,$OPestado,$Nfe,
	$Pispasep,$EMdatainicio,$EMdatafim, $EMcep, $EMfone, $FCcelular, $Mmunicipio, $Ccomplemento, $Bbairro)=$sql_dados_empresa->fetch(); 
