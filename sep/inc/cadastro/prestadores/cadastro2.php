	...
	if(($_POST['CODEMISSOR'])){		   
		...
		$sql=$PDO->query("
						...
						WHERE
							codigo='$codigo'
						");
		list($codigo,$codtipo,$codtipodec,$nome,$razaosocial,$cnpjcpf,$inscrmunicipal, $logradouro,$numero,$complemento,$bairro,$fone,$celular,$cep,$municipio,$uf,$logo,$email,$ultima,$notalimite,$estado,$codcontador,$nfe,$pispasep,$datafim,$isentoiss)= $sql->fetch();
...
<table border="0" cellspacing="0" cellpadding="0" class="form">
	...
	<form  method="post" name="frmCadastroEmpresa" id="frmCadastroEmpresa">
		...
		<table id="bigtable">
            ...
            <tr>
                <td colspan="4" align="right"><font color="#FF0000">*</font> Campos Obrigatórios<br /> <strong><font color="#FF0000">**</font> Você deve desligar o bloqueador de pop-ups para cadastrar</strong></td>
         	</tr>
		</table>
		</fieldset>
