						...
						<table width="100%">
							...
							<tr>
								<td align="left" colspan="2">
									<input name="btPesquisar" type="submit" class="botao" value="Pesquisar" onclick="acessoAjax('inc/declaracoes/des/declarar_pesquisa.ajax.php','frmDes','divDeclaracoesSimples')" />
									<input name="btNova" type="submit" class="botao" value="Nova declaração" onclick="acessoAjax('inc/declaracoes/des/verifica_cnpj.ajax.php','frmDes','divDes')" />
									<input name="btGuia" value="Guias" type="submit" class="botao" onclick="acessoAjax('inc/declaracoes/des/guias/verifica_cnpj_guias.ajax.php','frmDes','divDes')" />
