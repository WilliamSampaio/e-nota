...
<table border="0" cellspacing="0" cellpadding="0" bgcolor="#CCCCCC">
  <tr>
    ...
    <td width="500" background="img/form/cabecalho_fundo.jpg" align="left" class="formCabecalho">Institui��es Financeiras - Auditoria </td>
                    ...
                    <tr align="left">
                        ...
                        <td>
                            <select name="cmbInstFinanceira">
                                <option></option>
                                <?php
                                    $sql=$PDO->query("SELECT codigo, razaosocial FROM inst_financeiras");
