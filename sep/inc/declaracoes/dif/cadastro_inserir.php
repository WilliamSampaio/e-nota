...
?>
<?php
	// verifica se já há alguma inst. financeira cadastrada com o cnpj indicado. caso é haja, faz o cadastro 
	$sql_verifica=$PDO->query("SELECT cnpj FROM inst_financeiras WHERE cnpj='$cnpj'");
	if($sql_verifica->rowCount()>0)
		...
		{
			$PDO->query("INSERT INTO inst_financeiras 
			...
			$corpo="
				...
				Para acessar o o sistema do ISSDigital acesse o site {$config['host']}, o login é próprio CNPJ da instituição. A senha, gerada pelo sistema, �: $senha<br>
