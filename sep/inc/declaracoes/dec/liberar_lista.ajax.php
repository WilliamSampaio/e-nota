...
<?php
	...
	$sql_pedidos = $PDO->query("SELECT codigo, nome, cnpj FROM cartorios WHERE estado = 'NL' $string ORDER BY nome");
	if($sql_pedidos->rowCount()>0){
?>
<fieldset><legend>Resultados encontrados: <?php echo $sql_pedidos->rowCount(); ?></legend>
	<table width="100%">
		<tr bgcolor="#999999">
...
<div <?php if($sql_pedidos->rowCount()>15){ echo "style=\"overflow:auto; height:250px\"";}?>>
	<table width="100%">
		<?php
