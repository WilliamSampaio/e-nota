...
<table border="0" cellspacing="0" cellpadding="0" class="form">
  <tr>
    ...
    <td width="650" background="img/form/cabecalho_fundo.jpg" align="left" class="formCabecalho">Declrações de Cartórios<br /></td>  
                    ...
                    <tr>
                        ...
                        <td align="left">
                            ...
                            <select name="cmbAno" class="combo">
                            	<option value=""></option>
                                <?php
								$sql_ano = $PDO->query("SELECT SUBSTRING(competencia,1,4) FROM cartorios_des GROUP BY SUBSTRING(competencia,1,4) ORDER BY SUBSTRING(competencia,1,4) DESC");
