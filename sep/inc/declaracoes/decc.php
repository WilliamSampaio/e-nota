...
<?php
	if($_POST['btDeclarar'] == "Declarar"){
		require_once("inc/declaracoes/decc/declarar_sql.php");
	}
	if($_POST["btBoleto"] == "Gerar Boleto"){
		require_once("inc/declaracoes/decc/guias/gerar_boleto.php");
	}
?>
<table border="0" cellspacing="0" cellpadding="0" class="form">
  <tr>
    <td width="18" align="left" background="img/form/cabecalho_fundo.jpg"><img src="img/form/cabecalho_icone.jpg" /></td>
    <td width="650" background="img/form/cabecalho_fundo.jpg" align="left" class="formCabecalho">Declarações de Empreiteiras<br /></td>  
