...
<?php 
	if($_POST['btEnviar']){
		require_once("inc/declaracoes/dif/verifica_xml.php");
	}
	if($_POST["btBoleto"] == "Gerar Boleto"){
		require_once("inc/declaracoes/dif/guias/gerar_boleto.php");
	}
?>
<table border="0" cellspacing="0" cellpadding="0" class="form">
  <tr>
    <td width="18" align="left" background="img/form/cabecalho_fundo.jpg"><img src="img/form/cabecalho_icone.jpg" /></td>
    <td width="650" background="img/form/cabecalho_fundo.jpg" align="left" class="formCabecalho">Declarações de Instituição financeira<br /></td>  
