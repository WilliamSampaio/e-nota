...
for($i=0; $i<$cont; $i++){
	if($_POST["ckISS".$i]){
		...
		$PDO->query("INSERT INTO guias_declaracoes SET codguia='$codguia', codrelacionamento='$coddeclaracao[1]', relacionamento='decc_des'");
		$PDO->query("UPDATE decc_des SET estado='B' WHERE codigo='$coddeclaracao[1]'");
	}
}
