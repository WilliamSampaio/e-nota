...
<table border="0" cellspacing="0" cellpadding="0" class="form">
  <tr>
    ...
    <td width="850" background="img/form/cabecalho_fundo.jpg" align="left" class="formCabecalho">Empreiteiras - Relatórios</td>
  ...
  <tr>
    ...
    <td align="center">
    	<form method="post" name="frmRelatorio" id="frmRelatorio" onsubmit="return false">
        	<fieldset><legend>Relatórios de Empreiteiras</legend>
                <table width="100%">
                    <tr>
