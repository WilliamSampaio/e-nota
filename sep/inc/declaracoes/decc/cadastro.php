  ...
  <tr>
    ...
    <td align="center">
      ...
      <table border="0" align="center" id="tblEmpresa">	   
       ...
       <tr>
        <td align="left">
		 Endereço<font color="#FF0000">*</font>		</td>
        <td align="left">
	   ...
	   <tr>
	     ...
	     <td align="left"><input type="checkbox" value="s"  name="txtNfe" id="txtNfe" <?php if($nfe =='s'){echo "checked=\"checked\"";} ?>/>
           <em>Esta empresa emite Nota Fiscal eletrônica</em></td>
	   </tr>
       ...
       <tr>
         <td colspan="2" align="right"><font color="#FF0000">*</font> Campos Obrigatórios<br /> </td>
         </tr>
      </table>       
      </fieldset>
