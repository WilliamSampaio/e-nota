...
if ($_POST['btCadastrar'] !=""){
	...
	$sql=$PDO->query("
		...
		WHERE 
			codigo ='$Cod'
	"); 
	list($codservico,$descricao,$aliquota,$aliquotair,$estado,$Tipopessoa,$Basecalculo,$Incidencia,$Datavenc,$Doc,$Valor_RPA)=$sql->fetch();
	if(($codservico != $codServico) || 
	    ...
	    $sql_codservico = $PDO->query("SELECT codigo FROM servicos WHERE codservico = '$codServico' AND codigo <> '$Cod'");
	    $sql_descricao = $PDO->query("SELECT codigo FROM servicos WHERE descricao = '$descServico' AND codigo <> '$Cod'");
...
$sqlEditar=$PDO->query("SELECT codservico, descricao,aliquota,aliquotair,estado,tipopessoa,basecalculo,incidencia,datavenc,docfiscal,valor_rpa FROM servicos WHERE codigo ='$nossonumero'"); 
list($codservico,$descricao,$aliquota,$aliquotair,$estado,$tipopessoa,$basecalculo,$incidencia,$datavenc,$doc,$valorRPA)=$sqlEditar->fetch(); 
 
?>
<table width="98%" align="center">
    <tr>
     <td>
      <fieldset><legend>Ediãão de Serviços</legend>
      <form  method="post" id="frmEditar">   
		  ...
		  <table width="100%" border="0" align="center">
		   ...
		   <tr>
				...
				<select name="cmbEdTipoPessoa" id="cmbInsTipoPessoa" class="combo">
                  ...
                  <option value="PF" <?php if($tipopessoa =='PF'){echo"selected=\"selected\"";}?>>Pessoa Física</option>
		   ...
		   <tr>
			 ...
			 <td align="left">
			  <input type="text" size="5" maxlength="5" name="txtEdAliquota" class="texto" value="<?php print $aliquota; ?>" onkeyup="MaskPercent(this)" />
			   %Exemplo(0.00)</td>
			 <td align="left"><em>Para serviços em geral </em></td>
		   </tr>
		   <tr>
			 <td>Retenção ISS </td>
			 <td align="left">
			  <input type="text" size="5" maxlength="5" name="txtEdAliquotaIR" class="texto" value="<?php print $aliquotair; ?>" onkeyup="MaskPercent(this)" />
			   %Exemplo(0.00)		  </td>
			 <td align="left"><em>Para serviços com ISS Retido</em></td>
		   </tr>	  
		   <tr>
		  ...
		  <tr>
			...
			<td align="left" colspan="2">
				...
				* Valor para Declaração de Autônomo
			</td>
		  </tr>
		  <tr>
		   ...
		   <tr>
			...
			<td width="223"  style="font-size:10px;" align="right">
			 <font color="#FF0000">*</font>Campos Obrigatórios		</td>
		   </tr>   
		  </table>   
      </form>
