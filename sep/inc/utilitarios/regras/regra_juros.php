...
<?php
	if($_POST['btSalvar'] == "Salvar"){
		require_once("inc/utilitarios/regras/regras_juros_salvar.php");
	}
	if($_POST['btEditar'] == "Salvar"){
		require_once("inc/utilitarios/regras/regras_juros_editar.php");
	}
	if($_POST['btExcluir'] == " "){
		require_once("inc/utilitarios/regras/regras_juros_excluir.php");
	}
?>
