...
list($codigo, $assunto, $especificacao, $tomador_cnpj, $tomador_email, $rps_numero, $rps_data, $rps_valor, $empresa_nome, $empresa_cnpjcpf, $datareclamacao, $estado, $dataatendimento,$prest_email,$descricao) = $sql->fetch();


$sql_config = $PDO->query("SELECT cidade, secretaria, brasao FROM configuracoes");
list($CIDADE,$SECRETARIA,$BRASAO) = $sql_config->fetch();
