...
list($codigo, $assunto, $especificacao, $tomador_cnpj, $tomador_email, $rps_numero, $rps_data, $rps_valor, $empresas_nome, $empresas_cnpj, $empresas_cpf, $datareclamacao, $estado, $responsavel, $dataatendimento, $descricao) = $sql->fetch();
