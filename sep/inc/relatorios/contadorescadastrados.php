...
<tr>
	...
	<td width="700" background="img/form/cabecalho_fundo.jpg" align="left" class="formCabecalho">Relatórios - Contadores </td>
		...
		<table align="left" width="100%">
			<tr>
				...
				<td>
                    ...
                    <label><input type="radio" name="rdbContador" value="NL" >Não Liberados</label>
			  	</td>
			</tr>
       	</table>
    	</fieldset>
