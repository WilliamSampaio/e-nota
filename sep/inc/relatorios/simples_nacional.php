...
<div id="divBusca"  >
	<?php require_once("inc/relatorios/busca_simples_nacional.php"); ?>
</div>
<?php 
...
<table border="0" cellspacing="0" cellpadding="0" bgcolor="#CCCCCC">
  <tr>
    ...
    <td width="700" background="img/form/cabecalho_fundo.jpg" align="left" class="formCabecalho">Relatórios - Simples Nacional</td>
