...
<tr>
	...
	<td width="700" background="img/form/cabecalho_fundo.jpg" align="left" class="formCabecalho">Relatórios - AIDFe </td>
    ...
    <td align="center">
		...
		<table align="left" width="100%">
			<tr>
				...
				<td>
					<label><input type="radio" name="rdbAidfe" value="historico" checked>Histórico</label>
			    </td>
			</tr>
       	</table>
    	</fieldset>
