...
<table width="95%" height="120" border="2" cellspacing="0" class="tabela">
  <tr>
    ...
    <td width="584" height="33" colspan="2"><span class="style1">
      <center>
             <p>LISTA ESTAT&Iacute;STICA DE SERVIÇOS POR CATEGORIA</p>
  ...
  <table width="95%" border="2" cellspacing="0" class="tabela" style="page-break-after: always">
      ...
      <?php  //comando sql que mostrará as categorias e a quantidade de cada um (Lista Estatística)
        ...
        while(list($nome,$qtd,$codCategoria)=$sql_categ->fetch()){
            ...
            echo "
                ...
                <tr bgcolor=\"grey\">
                    <td align=\"center\" colspan=\"2\">Serviços da categoria $nome</td>
            ...
            ");
            $contServicos = 0;
            while($servicos = $sqlServicos->fetchObject()){
    ...
    <tr bgcolor="grey">
        ...
        <td align="center">Total de Serviços: <?php echo $total; ?></td>
