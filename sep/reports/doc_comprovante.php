...
<table width="800" border="0" cellspacing="0" cellpadding="5" align="center">
  <tr>
	...
	<table border="0" cellspacing="0" cellpadding="5" style="border: 0px;">
      <tr>
		...
		Comprovante de Declaração Operadoras de Crédito</font></td>
      </tr>
    </table></td>
  </tr>
  <tr>
  ...
  <tr>
    <td height="200" colspan="4" align="center" valign="middle"><span class="style1">A Prefeitura Municipal de <font class="prefeitura"><?php echo $CONF_CIDADE; ?></font> certifica que a Operadora de crédito citada acima concluiu o processo de Declaração  Operadora de crédito, referente ao período <font class="prefeitura"><?php echo DataPt($competencia); ?></font>.</span>   </td>
  </tr>
  <tr>
