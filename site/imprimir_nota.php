...
");
		list(
			...
			$empresa_logo, $issretido, $codtipo, $pispasep, $codtipodec, $observacao, $cofins, $contribuicaosocial) = $sql->fetch();
		...
		<body>
			<center>
				...
				<table width="800" border="0" cellspacing="0" cellpadding="2" style="border:#000000 1px solid;border-collapse:collapse">
					<tr>
						...
						<td width="25%" colspan="2" align="left" style="border:#000000 1px solid">N&uacute;mero da Nota<br />
							<div align="center">
					...
					<tr>
						<td align="left" colspan="2" style="border:#000000 1px solid">Data e Hora de Emiss&atilde;o<br />
							<div align="center">
					...
					<tr>
						<td align="left" colspan="2" style="border:#000000 1px solid">C&oacute;digo de Verifica&ccedil;&atilde;o<br />
							<div align="center">
				...
				");
										...
										<table class="gridview" align="center">
											...
											<?php
											$totalALiquota = 0;
											while ($servicos_dados = $servicos_sql->fetchAll(PDO::FETCH_ASSOC)) {
											?>
												<tr>
			...
			<td colspan="6" align="left" style="border:#000000 1px solid">C�digo do Servi�o<br /><strong><?php print $servico_codservico . " - " . $servico_descricao; ?></strong></td>
					...
					<tr>
						...
						?>
							<td style="border:#000000 1px solid">Dedu��es (R$)<br />
								<div align="right"><strong><?php print DecToMoeda($valordeducoes); ?></strong></div>
							</td>
							<td style="border:#000000 1px solid">Acr�scimos (R$)<br />
						...
						<td colspan="6" style="border:#000000 1px solid" align="left">
							...
							if ($valorirrf > 0) { //soh mostra se tiver valor
								if ($aliqirrf > 0) {
									...
									echo "- Reten&ccedil;&atilde;o de IRRF com valor de R$ " . DecToMoeda($valorirrf) . "";
									if ($deducao_irrf > 0) {
										echo ". Dedu&ccedil;&atilde;o de R$ " . DecToMoeda($deducao_irrf);
									}
									echo "<br>";
								}
							}
