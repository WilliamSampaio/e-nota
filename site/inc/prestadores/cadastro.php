...
<table width="580" border="0" cellpadding="0" cellspacing="1">
	<tr>
		...
		<td width="100" align="center" bgcolor="#FFFFFF" rowspan="3">Cadastro de Prestadores</td>
			...
			<form action="inc/prestadores/inserir.php" method="post" name="frmCadastroEmpresa" id="frmCadastroEmpresa">
				<table width="480" border="0" align="center" id="tblEmpresa">
					...
					<tr>
						...
						<td align="left">
							<input type="text" size="20" maxlength="18" name="txtCNPJ" id="txtCNPJ" class="texto" onblur="ValidaCNPJ(this,'spanprestador');desabilitaSN(this,'txtSimplesNacional','ftDesc')" /><span id="spanprestador"></span>
						</td>
					</tr>
