	...
	if ($sql->rowCount() == 0) {
		...
		switch ($estado) {
			...
			case "A":
				...
				break;
			case "I":
				$estado = '<font color="#FF0000"><b>Contador inativo, entre em contato com a prefeitura.</b></font>';
				break;
		} //fim switch estado
			...
			<tr>
				<td height="60" colspan="3" bgcolor="#CCCCCC">
					...
					<table width="98%" height="100%" border="0" bgcolor="#CCCCCC" align="center" cellpadding="1" cellspacing="2">
						...
						?>
						<tr>
							<td height="25" colspan="4"><input type="button" name="btVoltar" value="Voltar" class="botao" onClick="window.location='contadores.php'"></td>
						</tr>
					</table>
				</td>
			</tr>
