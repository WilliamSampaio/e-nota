...
//SELECIONA O CODIGO DA EMPRESA
 ...
 {
  $NOME = $_SESSION['nome'];
  $sql_codigo_empresa = $PDO->query("SELECT codigo, ultimanota,municipio,uf,logradouro,numero FROM cadastro WHERE nome = '$NOME'");
  ...
  $sql_dadosprefeitura = $PDO->query("SELECT cidade, estado, cnpj, endereco, topo_nfe, brasao_nfe, secretaria FROM configuracoes");
