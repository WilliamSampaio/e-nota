    ...
    <form method="post">
        ...
        <table align="center">
            <tr>
                ...
                <td><input type="submit" class="botao" name="btBuscar" value="Buscar" onclick="return ValidaFormulario('_mes|_ano','Por favor selecione um m�s e um ano!')"/></td>
            </tr>
        </table>
    </form>
<?php
...
<tr bgcolor="#999999">
                        ...
                        <tr bgcolor="#FFFFFF" align="center">
                          ...
                          <td width="100" align="center">Cod. Verifica��o</td>
