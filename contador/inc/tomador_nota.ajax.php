...
<?php 
  ...
  if($cnpjcpf!=""){
	  $query=$PDO->query("SELECT nome,razaosocial,inscrmunicipal,logradouro,numero,complemento,bairro,cep,municipio,email,uf,codtipo FROM cadastro WHERE cnpj='$cnpjcpf' or cpf='$cnpjcpf'");
